...
class TitleTrigger(WordTrigger):
    def evaluate(self,title):
        self.text = title.getTitle().lower()
        return self.isWordIn(self.text)
    
# TODO: SubjectTrigger
class SubjectTrigger(WordTrigger):
    def evaluate(self,subject):
        self.text = subject.getSubject().lower()
        return self.isWordIn(self.text)
    
# TODO: SummaryTrigger
class SummaryTrigger(WordTrigger):
    def evaluate(self,summary):
        self.text = summary.getSummary().lower()
        return self.isWordIn(self.text)
...
class AndTrigger(Trigger):
    def __init__(self, tt1, tt2):
        ...
        self.tt2 = tt2
    def evaluate(self, story):
        if self.tt1.evaluate(story) and self.tt2.evaluate(story):
            return True
        else:
            return False
...
class OrTrigger(Trigger):
    ...
    def evaluate(self, story):
        if self.tt1.evaluate(story) or self.tt2.evaluate(story):
            return True
        else:
          return False
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        if (self.phrase in story.getSummary()) or (self.phrase in story.getTitle()) or (self.phrase in story.getSubject()):
            return True
        else :
            return False
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if(triggerType == "SUBJECT"):
        ...
        for i in params:
            Phrase += i + " "
        triggerMap[name] = PhraseTrigger(Phrase[:-1])
